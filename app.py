...
if df is not None:
    ...
    with st.sidebar:
        ...
        # --- LÓGICA DE BOTONES (SESSION STATE) ---
        # Inicializamos el estado si no existe
        if 'tipo_seleccionado' not in st.session_state:
            st.session_state.tipo_seleccionado = opciones_finales

        # El Multiselect ahora se vincula a la "key" del session state
    ...
    # 4. RESULTADOS
    if nat_sel:
        # Ordenar el DataFrame para los resultados
